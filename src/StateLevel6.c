...
const UWORD pal_grass_lightest6[]    = { RGB(31, 31, 31), RGB(29, 30, 28), RGB(30, 29, 26), RGB(31, 30, 31) };
...
const UWORD pal_wood_lightest6[]    = { RGB(31, 31, 31), RGB(30, 29, 28), RGB(30, 29, 26), RGB(31, 30, 31) };
...
const UWORD pal_nutmeg_lightest6[]    = { RGB(31, 31, 31), RGB(31, 31, 30), RGB(30, 29, 28), RGB(28, 28, 28) };
...
void Update_StateLevel6() {
	...
	// Up to 94:
		...
		SpriteManagerAdd(EnemyBunny, 51*8, 8*8);
