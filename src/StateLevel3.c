...
void Start_StateLevel3() {
	...
	SetPalette (BG_PALETTE, 0, 8, bg_palette_level2, bank_StateLevel3);
	SetPalette (SPRITES_PALETTE, 0, 8, sprites_palette_level2, bank_StateLevel3);
	...
	InitScroll(&level3map, collision_tiles_level2, 0);
