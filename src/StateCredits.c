...
static UINT8 anim_water_counterc = 0;

static const UINT8 collision_tiles_levelc[] = {0};
static const UINT8 collision_tiles_down_levelc[] = {0};

extern Sprite * spr_camera;

//water tiles are stored in 1A, 1B, and 1C
//in GBTD, water is 26, 27, 28
static const unsigned char levelc_water1[] = {
	0x00,0x08,0x08,0x3c,0x3c,0xff,0xff,0xfb,
	0xff,0xdf,0xf7,0xff,0x7f,0xff,0xfd,0xff
};

static const unsigned char levelc_water2[] = {
	0x00,0x20,0x20,0xf3,0xf3,0xff,0xff,0xff,
	0xdf,0xff,0xff,0xf7,0x7f,0xff,0xfd,0xff
};

static const unsigned char levelc_water3[] = {
	0x00,0x82,0x82,0xcf,0xcf,0xff,0xff,0xfb,
	0xdf,0xff,0xff,0xf7,0x7f,0xff,0xfd,0xff
};

//water anim data locations
static const unsigned char levelc_water_anim1[] = { 0x1A };
